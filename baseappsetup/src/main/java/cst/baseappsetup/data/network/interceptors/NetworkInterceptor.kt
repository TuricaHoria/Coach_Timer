package cst.baseappsetup.data.network.interceptors

import android.content.Context
import cst.baseappsetup.R
import cst.baseappsetup.data.network.CSTConnectivityStatus
import cst.baseappsetup.data.network.NetworkEventBus
import cst.baseappsetup.data.network.NetworkState
import cst.baseappsetup.data.network.NetworkErrorMessageCode
...
class NetworkInterceptor(private val context: Context) : Interceptor {
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
         ...
         * */
        if (!CSTConnectivityStatus.isConnected(context)) {
